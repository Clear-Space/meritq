...
<header id="pricingHeader" role="banner" style="background-image: url(<?php echo the_field('header_image') ?>);">
...
<nav id="access notHome" role="navigation">
    ...
    <div class="tourHeaderText contentContainer">
        ...
        <h3> <?php the_field('pricing_h2') ?> </h3>
        <p> <?php the_field('header_p') ?> </p>
