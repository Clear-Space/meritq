...
get_header('home'); ?>
    ...
    <section class="whyMerit contentContainer clearfix">
        ...
        <div class="whyBlock block1 clearfix">
        ...
        <div class="whyBlock block2 clearfix">
        ...
        <div class="whyBlock block3 clearfix">
        ...
        <div class="whyBlock block4 clearfix">
    ...
    <section class="inputExplained clearfix">
        ...
        <div class="interiorLeft">
                ...
                <img src="<?php the_field('inputimage') ?>" alt="">
        </div>        
    ...
    <section class="outputExplained clearfix">
        <div class="contentContainer">
            <div class="interiorRight">
                ...
                <img src="<?php the_field('outputimage') ?>" alt="">
            </div> 
    ...
    <section class="inputExplained clearfix">
        <div class="contentContainer">
            ...
            <div class="interiorLeft">
                <h2><?php the_field('action_title') ?>
                </h2>
                <img src="<?php the_field('actionimage') ?>" alt="">
            </div> <!-- end .interiorLeft -->
